*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVCONF_ITEM
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVCONF_ITEM         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVCONF_ITEM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVCONF_ITEM_EXTRACT
TOTAL = ZVCONF_ITEM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVCONF_ITEM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVCONF_ITEM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCONF_ITEM_EXTRACT
TOTAL = ZVCONF_ITEM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVCONF_ITEM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVCONF_ITEM'
...
TOTAL = ZVCONF_ITEM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVCONF_ITEM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVCONF_ITEM-UPD_FLAG NE SPACE.
